...
namespace CardiacPatientMonitoringSystem.API.Controllers
{
    ...
    public class AppointmentsController : ControllerBase
    {
        ...
        /// </param>
        /// <response code="200">
        /// The appointment was found and returned successfully.
        /// </response>
        /// <response code="404">
        /// The appointment was not found or does not belong to the authenticated patient.
        /// </response>
        /// <response code="401">
        ...
        /// </summary>
        /// <param name="request">
        /// The appointment details to create.
        /// </param>
        /// <response code="201">
        /// The appointment was created successfully.
        /// </response>
        /// <response code="400">
        /// The appointment request is invalid.
        /// </response>
        /// <response code="401">
        /// Authentication is required.
        /// </response>
