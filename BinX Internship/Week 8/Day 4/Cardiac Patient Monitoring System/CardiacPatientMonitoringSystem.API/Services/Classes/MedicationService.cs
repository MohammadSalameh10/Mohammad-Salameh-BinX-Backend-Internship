...
namespace CardiacPatientMonitoringSystem.API.Services.Classes
{
    public class MedicationService : IMedicationService
    {
        ...
        public MedicationService(ApplicationDbContext context, IDistributedCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        public async Task<List<MedicationResponse>> GetAllAsync(string? name)
        {
            ...
            const string cacheKey = "medications:all";

            var cachedMedications = await _cache.GetStringAsync(cacheKey);
